...
(function () {
  ...
  function apply() {
    ...
    document.querySelectorAll('.me img, .profile-photo-wrap > img, .story-create img, .ig-profiles .profile-avatar:not(.gray) img, .account-sheet-avatar').forEach(function (image) {
      image.src = avatar;
